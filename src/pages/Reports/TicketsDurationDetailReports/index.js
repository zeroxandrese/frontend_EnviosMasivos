...
const TicketsDurationDetailReports = () => {
  ...
  return (
    <MainContainer className={classes.mainContainer}>
      ...
      <MainHeader>
        <Title>Informe de duración del servicio - { contact ? contact.name || '' : '' } </Title>
      ...
      <Paper className={classes.mainPaper} variant="outlined">
        ...
        {isLoading === false && (
          ...
          >
            <TableHead>
              <TableRow>
                <TableCell align="center"> Inicio del servicio</TableCell>
                <TableCell align="center"> Última actualización </TableCell>
                <TableCell align="center"> Status </TableCell>
                <TableCell align="center"> Último asistente </TableCell>
                <TableCell align="center"> Duración después de la finalización </TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
