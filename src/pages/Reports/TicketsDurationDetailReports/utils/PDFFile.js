    ...
    <Document>
      <Page style={classes.page} size="A4">
        ...
        <View style={classes.titleContainer}>
          <Text style={classes.title}>Lista de servicios prestados - {name} </Text>
        </View>
        ...
        <View style={{
          ...
          <Text style={{ width: '20%', ...classes.headerText }}>Inicio del servicio</Text>
          ...
          <Text style={{ width: '20%', ...classes.headerText }}>
            Duración después de la finalización
          </Text>
        </View>
