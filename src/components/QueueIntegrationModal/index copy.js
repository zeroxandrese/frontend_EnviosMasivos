                ...
                {(values.type === "typebot") && (
                  <Grid container spacing={1}>
                    ...
                    <Grid item xs={12} md={6} xl={6} >
                      <Field
                        as={TextField}
                        label={i18n.t("Tempo em minutos para expirar uma conversa")}
                        name="typebotExpires"
                    ...
                    <Grid item xs={12} md={6} xl={6} >
                      <Field
                        as={TextField}
                        label={i18n.t("Palavra para finalizar o ticket")}
                    ...
                    <Grid item xs={12} md={6} xl={6} >
                      <Field
                        as={TextField}
                        label={i18n.t("Palavra para reiniciar o fluxo")}
                    ...
                    <Grid item xs={12} md={6} xl={6} >
                      <Field
                        as={TextField}
                        label={i18n.t("Mensagem de opção inválida")}
