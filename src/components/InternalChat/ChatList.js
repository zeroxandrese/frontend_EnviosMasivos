...
export default function ChatList({
  ...
  const getItemStyle = (chat) => {
    return {
      borderLeft: chat.uuid === id ? "6px solid " + theme.palette.primary.main : null,
      backgroundColor: chat.uuid === id ? theme.palette.background.paper : null,
    };
  };
  ...
  return (
    <>
      ...
      >
        Esta acción no se puede revertir, ¿puede confirmarlo?
      </ConfirmationModal>
